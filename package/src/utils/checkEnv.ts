...
export function checkEnv( 
    ...
    if (!viteEnv.INFISICAL_CLIENT_SECRET) {
        Logger(loggerOpts.logError, 'INFISICAL_CLIENT_SECRET is not set. Please set it in your .env file.');
        throw new AstroError('INFISICAL_CLIENT_SECRET is not set. Please set it in your .env file.');
    }
    if (!viteEnv.INFISICAL_PROJECT_ID) {
        Logger(loggerOpts.logError, 'INFISICAL_PROJECT_ID is not set. Please set it in your .env file.');
